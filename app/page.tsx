...
export default function StuntingLandingPage() {
  ...
  const whatsappNumbers = [
    { name: "Poliklinik Biddokkes Polda DIY", number: "6289519100422" },
    { name: "Poliklinik Polresta Yogyakarta ", number: "6282325600253" },
  ]
  ...
  },
  {
    ...
    answer: "Penanganan berfokus pada intervensi gizi untuk mengejar ketertinggalan tumbuh kembang. Ini meliputi: 1) Pemberian asupan gizi yang adekuat, terutama kaya protein hewani. 2) Mengatasi penyakit infeksi yang diderita. 3) Memberikan stimulasi psikososial yang tepat. 4) Rutin memantau pertumbuhan di fasilitas kesehatan untuk evaluasi.",
  },
  {
    id: "not-only-poor",
    question: "Apakah stunting hanya terjadi pada keluarga miskin?",
    answer: "Tidak. Meskipun kemiskinan adalah faktor risiko karena membatasi akses ke gizi, stunting bisa terjadi di keluarga mampu. Faktor lain seperti kurangnya pengetahuan gizi, pola asuh yang salah, seringnya anak sakit karena sanitasi buruk, dan tidak rutin ke Posyandu juga merupakan penyebab penting.",
  },
  {
    id: "most-influential-factor",
    question: "Faktor apa yang paling berpengaruh terhadap terjadinya stunting?",
    answer: "Faktor yang paling berpengaruh adalah asupan gizi yang tidak memadai dan infeksi berulang. Ini dipengaruhi oleh berbagai hal, seperti kesehatan ibu saat hamil, praktik pemberian ASI dan MPASI yang kurang tepat, kebersihan lingkungan, serta terbatasnya akses ke layanan kesehatan.",
  },
  {
    id: "posyandu-role",
    question: "Apa peran Posyandu dalam pencegahan stunting?",
    answer: "Posyandu berperan sebagai garda terdepan untuk: 1) Memantau pertumbuhan anak secara rutin (timbang berat dan ukur tinggi badan). 2) Memberikan edukasi gizi kepada ibu hamil dan balita. 3) Melakukan deteksi dini jika ada tanda gangguan pertumbuhan dan merujuk ke Puskesmas. 4) Memberikan layanan kesehatan dasar seperti imunisasi dan vitamin A.",
  },
  {
    id: "raising-awareness",
    question: "Bagaimana cara meningkatkan kesadaran masyarakat tentang stunting?",
    answer: "Kesadaran dapat ditingkatkan melalui: 1) Edukasi berkelanjutan di Posyandu dan Puskesmas. 2) Kampanye media massa dan digital yang mudah dipahami. 3) Pelibatan tokoh masyarakat dan agama sebagai panutan. 4) Memastikan informasi stunting mudah diakses oleh semua lapisan masyarakat.",
  },
];
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#E0F7FA" }}>
      ...
      <section className="py-12 md:pb-20">
        <div className="container mx-auto px-4">
          ...
          {/* Baru teks setelah poster */}
          <div className="text-center mb-12">
  <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
    Layanan Edukasi dan Konseling Kesehatan Calon Pengantin
  </h2>
  <p className="text-3xl text-gray-600 font-bold max-w-3xl mx-auto">
    Untuk Kesehatan Reproduksi dan Pencegahan Stunting
  </p>
</div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Periode emas pencegahan stunting
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white/80 backdrop-blur-sm">
          ...
          <div className="bg-white/50 rounded-2xl p-8 md:p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Mulai Langkah Pencegahan Sekarang
              </h2>
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Konsultasikan dengan tenaga kesehatan terdekat untuk mendapatkan
                panduan yang tepat sesuai kondisi ibu dan bayi.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  onClick={handleFindNearbyPuskesmas}
                  className="w-full sm:w-auto px-6 py-3 bg-white text-teal-600 border border-teal-600 rounded-lg text-base font-medium shadow-sm transition duration-300 hover:bg-teal-50 hover:shadow-md"
                >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  <DialogTrigger asChild>
                    <button className="w-full sm:w-auto px-6 py-3 text-white bg-teal-600 hover:bg-teal-700 rounded-lg text-base font-medium shadow-md transition duration-300 transform hover:scale-105">
                ...
                <a
                  ...
                  className="w-full sm:w-auto px-6 py-3 text-gray-600 hover:text-teal-600 font-medium transition duration-300 underline"
                >
                  Kritik & Saran
                </a>
              </div>
